# Общие файлы конфигурации для инструментов авторов курсов HTML Academy

Собираем здесь конфиги для спеллеров и линтеров. Репозиторий решает в первую очередь задачи авторов курсов HTML Academy, поэтому распространяется в неизменённом виде.

Любое изменение вносится через пулл реквест с как минимум одним апрувом от каждого направления.
